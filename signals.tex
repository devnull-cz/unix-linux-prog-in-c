...
\sltitle{Signals}
\begin{itemize}
\item notify a process of asynchronous events, and handle exceptions
...
though.  \item Sending a signal to another process:
    ...
    \end{itemize}
\item Example (covers handling of the signal as well, see upcoming slides for
details): \priklad{signals/kill.c}
