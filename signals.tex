...
\texttt{SIGKILL} & kill program (exit, \emsl{cannot handle nor ignore})\\
...
configuration file changed and that it should read it again.
...
because "it's the simplest way to kill a process" as you might run in troubles.
