...
without \texttt{htonl}.  Never do it that way.  Next time you put an IP address
there, you may forget to add \texttt{htonl} and you are going to run into some
issues right away.  And again, if you write code agnostic to specific address
families, you do not need to worry about network byte ordering for addresses and
ports whatsoever.
