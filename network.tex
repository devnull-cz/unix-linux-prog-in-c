...
\pdfbookmark[0]{sí»ová komunikace}{site}
\begin{slide}
\sltitle{Obsah}
\begin{itemize}
...
Linux, FreeBSD, Mac OS X i Solaris pou¾ívají pro toto makro hodnotu 128.
...
\pdfbookmark[1]{TCP klient}{tcpclientcode}
\label{TCPCLNTEXAMPLE}

\begin{slide}
\sltitle{Pøíklad: TCP klient}
\begin{alltt}
