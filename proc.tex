...
\item Example: \priklad{pipe/broken-pipe.c}
\end{itemize}
...
\begin{itemize}
\item Remember, open file descriptors are unaffected by \funnm{exec}
aside from file descriptors with flagged as \texttt{FD\_CLOEXEC} -- those are
closed in the \emsl{successful} \funnm{exec} call.
\item Example: \priklad{pipe/pipe-and-fork.c}
