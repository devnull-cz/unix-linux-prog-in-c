...
program it started, ie. the parent, and it does not care about the program
children at all.  If the pipe was created the other way around, the shell could
print the prompt while the data from the still living child could might be
still flowing on the console.
