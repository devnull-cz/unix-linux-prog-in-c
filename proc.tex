...
\item Example: \priklad{pipe/broken-pipe.c}, \priklad{pipe/deadlock-in-read.c}
\end{itemize}
...
\item flags for \emph{mode} of \funnm{dlopen}:
    ...
    (Solaris) or \texttt{ld.so} (Linux).  Example: \priklad{dyn-lib/ld-lazy.c}.
...
\item Example: \priklad{dyn-lib/dlopen.c}
\end{itemize}
