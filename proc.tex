...
Mac~OS~X (which is a certified UNIX system) that uses the \emph{Mach-O} format,
short for the \emph{Mach Object} file format.  Each Mach-O file is made up of
one Mach-O header, followed by a series of load commands, followed by one or
more segments, each of which contains between 0 and 255 sections.
