...
\centerslidestrue
\begin{center}
\title{\LARGE Programování v UNIXu}
\author{(NSWI015)}
\date{verze: \rm\today}
\maketitle
...
\begin{itemize}
\item Toto jsou oficiální materiály pro výuku pøedmìtu \emph{Programování v
UNIXu} (kód pøedmìtu NSWI015) na Matematicko-fyzikální fakultì Univerzity
Karlovy.
\item Tyto materiály jsou uveøejnìny pod licencí
\href{http://creativecommons.org/licenses/by-nc-sa/3.0/cz/}{Creative Commons BY-NC-SA 3.0}.
Soubory k ukázkovým pøíkladùm uvedené vý¹e jsou
\href{http://creativecommons.org/licenses/publicdomain/}{Public Domain}, pokud v nich není
uvedeno jinak.
\item Tento pøedmìt je 2/1, cvièení bude jednou za dva týdny.
\item V¹echny informace, které budete potøebovat, a materiály k pøedná¹ce jsou
na \url{http://mff.devnull.cz/}, vèetnì aktuální verze tìchto poz\-nám\-ko\-vých
slajdù (\url{http://mff.devnull.cz/pvu/slides/}).  \textbf{Døíve, ne¾ zaènete
ma\-te\-ri\-á\-ly po\-u\-¾í\-vat, pøe\-svìdète se, ¾e není no\-vìj\-¹í verze!}
\item Ukázkové pøíklady jsou na 
\url{http://mff.devnull.cz/pvu/src/},
pokud se budu v poznámkách odkazovat na konkrétní pøíklad, link zde uvedený
slou¾í jako koøenový adresáø.
\item Je potøeba se zapsat na cvièení v SISu.
\item Zápoèet je za zápoètový program.
\item Zkou¹ka má písemnou a ústní èást.
\item Zkou¹et se bude to, co bude odpøedneseno (kromì témat na vyplnìní
pøípadnì zbylého èasu). Vìt¹ina informací je ve slajdech, ale øada dùle¾itých
podrobností mù¾e chybìt.
\item Pøedpoklady:
\begin{itemize}
\item U¾ivatelská znalost UNIXu, programování v shellu na úrovni
pøedná¹ky \uv{Úvod do UNIXu} (NSWI095)
\item Znalost jazyka C
\item Znalost základních pojmù teorie operaèních systémù
\end{itemize}
\item Tento text je prùbì¾nì doplòován, ChangeLog zaèíná na stranì
\pageref{CHANGELOG}. Upozornìní na chyby prosím posílejte na kontakty,
které najdete na vý¹e uvedené stránce.
\end{itemize}
...
%%%%%
\pdfbookmark[0]{úvod, vývoj UNIXu a C, programátorské nástroje}{uvod}
...
privilege model} v Solarisu nebo \emph{privilege separation} a \emph{systrace}
v OpenBSD.
