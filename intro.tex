...
\item From those systems above, only Solaris, macOS, AIX, and HP-UX are UNIX~03
compliant (\url{http://www.opengroup.org/openbrand/register/}).  Other, non
certified systems, are often described as ``Unix-like'', even that in many cases
they closely follow the standard.  However, word ``Unix'' is often used for
systems from either group.
