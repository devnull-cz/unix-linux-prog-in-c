...
Versions of Solaris, AIX, HP-UX a Mac~OS~X on various architectures are
compliant with the the previous version SUSv3
(\url{http://www.opengroup.org/openbrand/register/xy.htm}).
\item The specific source code examples are usually tested on Mac~OS and Linux.
\end{itemize}
...
\begin{slide}
\sltitle{Unix books in Czech}
\begin{enumerate}
\item Sko\v{c}ovsk\'{y}, L.: \emsl{Principy a probl\'{e}my opera\v{c}n\'{\i}ho
syst\'{e}mu UNIX}.  Science, 1993
\item Sko\v{c}ovsk\'{y}, Lud\v{e}k: \emsl{UNIX, POSIX, Plan9}. L.
Sko\v{c}ovsk\'{y}, Brno, 1998
\item Jelen, Milan: \emsl{UNIX V - programov\'{a}n\'{\i} v syst\'{e}mu}. Grada,
Praha 1993
\item \emsl{Linux - Dokumenta\v{c}n\'{\i} projekt}. Computer Press, 1998;
\url{http://www.cpress.cz/knihy/linux}
\item Herout, Pavel: \emsl{U\v{c}ebnice jazyka C}. 2 d\'{i}ly. Kopp,
\v{C}esk\'{e} Bud\v{e}jovice, 20?? (6. vyd\'{a}n\'{\i} prvn\'{\i}ho d\'{\i}lu)
\end{enumerate}

\end{slide}

\begin{itemize}
\item We recommend Unix books in English.  What is more, the list of books in
Czech is very probably outdated.
\end{itemize}
...
\item Advanced Unix.
\item Too old.
\item There is probably a newer version.
\item This is a great book on the C language.
\end{enumerate}

%%%%%

\begin{slide}
\sltitle{Unix system priciples and design}
...
based on another Unix classis book \emsl{The Design and Implementation of the
...
religiously followed by all in the group.  A good and followed cstyle leads to
less number of bugs in the code.
