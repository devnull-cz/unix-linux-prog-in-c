...
pass conformance tests are termed to be compliant with a UNIX standard UNIX~V7.
Versions of Solaris, AIX, HP-UX a macOS on various architectures are compliant
with the the previous version SUSv3
